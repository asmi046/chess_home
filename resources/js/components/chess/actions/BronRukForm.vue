<template>
    <div class="columns">
        ...
        <div class="column">
            <div class="field">
                <label class="label is-small">Менеджер</label>
                <div class="control">
    ...
    <div class="columns">
        <div class="column">
            <div class="field">
                <label class="label is-small">Имя клиента</label>
                <div class="control">
    ...
    <button @click.prevent="props.action()" class="button is-success is-small">Создать бронь руководителя</button>
